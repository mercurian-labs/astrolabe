...
export const RPC_REQUIRED_SCOPES = {
  ...
  [MERCURIAN_MEMORY_WS_METHODS.readMemoryCatalog]: AuthOrchestrationReadScope,
  [MERCURIAN_MEMORY_WS_METHODS.readMemoryDashboard]: AuthOrchestrationReadScope,
  [MERCURIAN_MEMORY_WS_METHODS.readMemoryDocument]: AuthOrchestrationReadScope,
  [MERCURIAN_MEMORY_WS_METHODS.readMemoryComparison]: AuthOrchestrationReadScope,
  [MERCURIAN_MEMORY_WS_METHODS.subscribeMemoryInvalidations]: AuthOrchestrationReadScope,
  ...
  [MERCURIAN_MEMORY_WS_METHODS.mergeMemoryHome]: AuthOrchestrationOperateScope,
