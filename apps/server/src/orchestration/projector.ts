  ...
  switch (event.type) {
    ...
    case "thread.turn-diff-completed":
      return Effect.gen(function* () {
        ...
        // Provider ingestion can race the real interrupted-turn capture with
        // a placeholder for the same turn. The placeholder carries neither
        // the orphan ref nor the partial fact and must not erase either.
