...
export const ProjectionTurn = Schema.Struct({
  ...
  checkpointRepositories: Schema.optional(Schema.Array(OrchestrationCheckpointRepository)),
  checkpointSummaryStatus: Schema.optional(OrchestrationCheckpointSummaryStatus),
  checkpointSummaryError: Schema.optional(Schema.String),
