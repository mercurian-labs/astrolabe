...
describe("PlanningToolkit", () => {
  it("offers distinct source-plan and derivation document doors beside the shared read", () => {
    ...
    expect(PlanningToolkit.tools.save_technical_plan.description).toContain(
      "derivation's only output door",
    );
