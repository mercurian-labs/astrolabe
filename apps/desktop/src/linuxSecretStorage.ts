...
function getGnomeKeyringRemediationMessage(): string {
  return "Astrolabe could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Astrolabe.";
}

function getKWalletRemediationMessage(): string {
  return "Astrolabe could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Astrolabe.";
}
