...
export class DesktopEnvironment extends Context.Service<
  DesktopEnvironment,
  {
    ...
    // Built web client the packaged renderer is served from over astrolabe://app.
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "astrolabe-dev" : "astrolabe";
  const legacyUserDataDirName = isDevelopment ? "Astrolabe (Dev)" : "Astrolabe (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.mercurian.astrolabe.dev" : "com.mercurian.astrolabe",
    ),
    linuxDesktopEntryName: resolveLinuxDesktopEntryName(isDevelopment),
    linuxWmClass: isDevelopment ? "astrolabe-dev" : "astrolabe",
