...
*Generated from the Goal/AC of Linear issue [M-176](https://linear.app/mercurian/issue/M-176/project-creation-repositories-in-the-dialog-and-creation-selects-the) (see the issue for the full AC). Design of record: almagest "Projects" § Creating a project (vault commit `2fa636a`).*
